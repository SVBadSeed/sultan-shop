...
const ButtonCart: React.FC<ButtonCardProps> = ({
                                                   id,
                                                   imageUrl,
                                                   name,
                                                   type,
    ...
    const onClickAdd = () => {
        const item = {
            imageUrl, name, type, size, barcode, producer, brand, description, price, typeCare, id, count: 0
        }
    ...
    return (
        <button onClick={onClickAdd} className='card-button'>в корзину
            {addedCount > 0 ? <i>{addedCount}</i> : <svg width="25" height="18" viewBox="0 0 25 18"
                                                         fill="none"
